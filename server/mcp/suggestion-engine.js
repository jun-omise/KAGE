...
const KEYWORD_MAP = {
  ...
  local_apps: {
    keywords: [
      ...
      'lightroom', 'acrobat', 'xd', 'adobe', 'creative cloud',
      // Other pro apps
      'final cut', 'logic pro', 'garageband', 'imovie', 'xcode',
      'sketch', 'affinity', 'blender', 'unity', 'figma app',
      'spotify', 'music', 'terminal', 'iterm', 'visual studio',
      'cursor', 'slack', 'discord', 'zoom', 'teams',
      'notion', 'obsidian', 'arc', 'brave', 'firefox',
      'vlc', 'handbrake', 'obs', 'steam',
      // Japanese
      'エクセル', 'スプレッドシート',
      'パワーポイント', 'プレゼンテーション',
      'スライド', 'アプリ', '起動', '開く',
      ...
      'プレミア', 'アフターエフェクト', 'ライトルーム',
      'アドビ', 'クリエイティブクラウド',
      'ファイナルカット', 'ロジックプロ',
    ],
    name: 'Local Apps',
    icon: '\uD83D\uDDA5\uFE0F',
    description: 'Launch and control local applications, Excel, PowerPoint, and any macOS app via AppleScript',
  },
};
